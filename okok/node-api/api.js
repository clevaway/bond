...
const sendInvite = async (request, response) => {
  ...
  let info = await transporter.sendMail({
    ...
    html:
      ...
      "</b></h1><h3>A friend wants to bond with you, Download and install Bond now to bond with your loved ones.</h3></br></br><h3>Click the link below to bond now.</h3></br><h3>https://bond-nu.vercel.app/bond/</h3>",
  });
  ...
  response
    ...
    .json([
      {
        status: "sent",
        message: "Bond invite sent successfully to " + request.params.email,
      },
    ]);
};
